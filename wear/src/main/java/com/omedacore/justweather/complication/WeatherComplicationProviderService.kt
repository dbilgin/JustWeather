package com.omedacore.justweather.complication
...
class WeatherComplicationProviderService : SuspendingComplicationDataSourceService() {
    ...
    override fun getPreviewData(type: ComplicationType): ComplicationData? {
        val icon =
            Icon.createWithResource(applicationContext, com.omedacore.justweather.R.drawable.x)
    ...
    override suspend fun onComplicationRequest(
        ...
        val iconResId = WeatherFormatter.getIconResId(weatherResponse)
