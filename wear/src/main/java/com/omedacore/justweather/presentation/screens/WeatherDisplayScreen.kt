package com.omedacore.justweather.presentation.screens
...
import com.omedacore.justweather.R
...
import com.omedacore.justweather.presentation.viewmodel.WeatherUiState
...
fun WeatherContent(
    ...
    val iconResId = WeatherFormatter.getIconResId(weather)
...
fun OpenWeatherAttribution() {
    ...
    Column(
        ...
        Image(
            painter = painterResource(id = R.drawable.openweatherlogo),
